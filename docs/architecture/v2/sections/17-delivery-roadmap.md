...
| Backtest depth | Historical walkforward harness depth beyond Phase 3; strategy comparison surfaces — **IMPLEMENTING (2026-08-12): IAF vendored + adapter (ADR-009)** |
