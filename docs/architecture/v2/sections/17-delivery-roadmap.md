...
| 3 | Advanced intelligence | **3A DONE (2026-08-01); 3B (research workspace) next** | 3A: session-gated shadow graduation (≥20 sessions, direction-aware, spec semantics), calibration→sizing, correlation block caps + conviction D/P/G live, walkforward breakdowns, learning endpoints — 563 tests green. 3B: research workspace draft briefs |
